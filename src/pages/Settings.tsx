      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5 space-y-4">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-0.5">Add your own categories or remove ones you do not use.</p>
          </div>

          {budgets.length === 0 && (
            <p className="text-gray-500 text-sm">No budget categories yet. Add one below.</p>
          )}
            ...
            <div key={item.id} className="space-y-1.5">
              <div className="flex items-center justify-between gap-2">
                <input
                  ...
                  className="flex-1 bg-transparent text-gray-300 text-sm font-medium focus:outline-none focus:text-white"
                />
                <button
                  type="button"
          ...
          <div className="border-t border-gray-800 pt-4 space-y-2">
            <label className="block text-gray-300 text-sm font-medium">Add category</label>
            <div className="flex gap-2">
              ...
              <MoneyInput
                ...
                className="w-28 bg-gray-800 border border-gray-700 text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent placeholder-gray-500"
              />
            </div>
            <button
              type="button"
              ...
              className="w-full flex items-center justify-center gap-1.5 bg-gray-800 hover:bg-gray-700 disabled:opacity-40 text-gray-200 font-medium py-2.5 rounded-xl text-sm transition-all border border-gray-700"
            >
              <Plus size={15} />
              Add category
            </button>
